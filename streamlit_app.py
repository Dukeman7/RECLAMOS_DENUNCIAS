...
if uploaded_file:
    ...
    if not df_filtered.empty:
        ...
        # Inicializamos el índice en la memoria si no existe o si excede el nuevo filtro
        if 'indice_reclamo' not in st.session_state or st.session_state.indice_reclamo >= total_filas:
        ...
        # 3. Diseño de la Ficha en Pantalla
        ...
        def generar_imagen(data):
            ...
            desc = str(data.get('Descripción', ''))[:100]
            d.text((50, 200), f"Descripción: {desc}...", fill=(0, 0, 0))
